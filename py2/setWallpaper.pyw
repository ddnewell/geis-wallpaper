...
#    print "complete."
    ...
    # p.loadImage(imageLoc='NaturalEarth2_Mercator.png', zorder=0, origin='upper')
    p.loadImage(imageLoc='NaturalEarth2_Mercator_Dell.png', zorder=0, origin='upper')
...
#    print "complete."
    ...
    p.plotWorldtime()
    p.addText(lon=-177., lat=-66., text='Daylight Updated:  {}'.format(p.localNow.strftime('%B %d, %Y  %I:%M%p')),\
